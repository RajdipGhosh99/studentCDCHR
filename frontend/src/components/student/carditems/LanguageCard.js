...
const LanguageCard = ({languageDetails, modelId, fetchStudentDataFromServer})=>{
    ...
    const [studentLanguageDetails, setStudentLanguageDetails] = useState({
      ...
      const inputFieldChange = (event)=>{
        ...
        setStudentLanguageDetails({...studentLanguageDetails, [fieldName]: fieldValue});
      }
      ...
      const editIconClick = ()=>{
        setStudentLanguageDetails({...studentLanguageDetails, _id: languageDetails._id, language: languageDetails.language, proficiency: languageDetails.proficiency});
      }
      ...
      const languageUpdateBtnClick = async ()=>{
        if(!language.trim() || !proficiency.trim()){
          ...
          try {
            ...
            const serverResponse = await axios.put(apiUrl, languageData, {withCredentials: true});
    ...
    return(
        ...
        <div className="card my-3 shadow" style={{backgroundColor: "#ebf0ed", border: "3px solid blue"}}>
          ...
          <div class="card-body">
            <p class="card-title"><b>Proficiency level: </b>{languageDetails.proficiency}</p>
          </div>
        </div>
        </div>
         ...
         <div className="modal-dialog modal-dialog-centered" role="document">
           <div className="modal-content">
             ...
             <div>
               <label htmlFor="exampleFormControlTextarea1" className=" form-label myprofile_form_label " style={{fontWeight: "700"}}>Language Name*</label>
               <TextField
               name="language"
               value={language}
              ...
              <div>
               <label htmlFor="exampleFormControlTextarea1" className=" form-label myprofile_form_label " style={{fontWeight: "700"}}>Proficiency*</label>
               <TextField
               name="proficiency"
               value={proficiency}
               onChange={inputFieldChange}
             ...
             <button type="button" className="btn btn-secondary" data-dismiss="modal"  >Close</button>
               ...
               <div>
               <button type="button" className="btn btn-primary update_profile_button" onClick={languageUpdateBtnClick} ><SaveIcon />Save</button>
               </div>
               <div>
               </div>
